...
1. お使いの仮想マシンの右にある **[有効にする]** ボタンを選択し、 **[レビューと有効化]** -  **[有効にする]** を選択します。
...
1. **[仮想マシンの削除 (仮想マシン)]** を見つけて選びます。 (2つある場合は下の方を選んでください。上の方は今回使用しない Microsoft.ClassicCompute リソースの可能性が高いです)。 その他の組み込みシグナルに注意してください。 **[適用]** を選択します
...
1. **[次へ: ルール設定]** を選択し、**[通知を表示しない]** を選択します。
