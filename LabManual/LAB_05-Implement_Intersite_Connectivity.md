...
1. **「az104-05-vm0」** ブレードで、**「接続」** をクリックし、**「RDP で接続する」** ブレードで **「RDP ファイルのダウンロード」** をクリックし、ダウンロードしたRDPファイルを実行してプロンプトに従ってリモート デスクトップ セッションを開始します。
...
1. **「az104-05-vm1」** ブレードで、**「接続」** をクリックし、**「RDP で接続する」** ブレードで **「RDP ファイルのダウンロード」** をクリックし、ダウンロードしたRDPファイルを実行してプロンプトに従ってリモート デスクトップ セッションを開始します。
