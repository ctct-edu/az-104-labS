...
1. 割り当てのリストで、**[タグとその値がリソースに必要]** ポリシーの割り当てを表す行の省略記号アイコンをクリックし、**[割り当ての削除]** メニュー項目を使用してこの割り当てを削除します。
...
1. **[ストレージ アカウントの作成]** ブレードの **[基本情報]** タブで、ポリシーが適用されたリソース グループを使用していることを確認し、次の設定を指定して **[確認]** をクリックします (その他の設定は既定値のままにします)。
