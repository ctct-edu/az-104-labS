...
1. **[次へ]** をクリックして、**[修復]** タブおよび**[マネージド ID の作成]** タブを確認します。 **[マネージド ID の作成]** チェックボックスのチェックは外したままにしておきます。 
...
1. ポータルで、 **[ストレージアカウント]** を検索して選択し、**[+ 作成]** を選択します。 

1. **[ストレージ アカウントの作成]** ブレードの **[基本]** タブで、構成を入力します。
...
1. **[確認と作成]** をクリックすると作成可能か検証が行われるため少し待ちます。
