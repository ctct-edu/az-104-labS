...
1. ストレージ アカウントのブレードに戻り、**[データ ストレージ]** セクションで、**[クラシック ファイル共有]** をクリックします。

1. **[+ クラシック ファイル共有]** をクリックし、**[基本]** タブでファイル共有に `share1` という名前を付けます。 
...
8. **[仮想ネットワーク]** セクションで、**[既存の仮想ネットワークを追加する]** を選択します。
