...
1. **[確認と作成]** を選び、検証プロセスが完了するのを待ってから、**[作成]** をクリックします。
...
1. **[データ管理]** セクションで、**[ライフサイクル管理]** を選び、**[ルールの追加]** を選びます。
...
1. **[レベル]** オプションを確認します。 既定の **[トランザクションが最適化されました]** のままにします。
   
1. **[バックアップ]** タブに移動し、**[バックアップを有効にする]** がオンになっていないことを確認します。 ラボの構成を簡素化するために、バックアップを無効にしています。

1. **[確認および作成]** をクリックし、**[作成]** をクリックします。 ファイル共有がデプロイされるまで待ちます。
...
1. 他のパラメーターの既定値を使用して、**[確認 + 作成]** を選択し、**[作成]** を選択します。
