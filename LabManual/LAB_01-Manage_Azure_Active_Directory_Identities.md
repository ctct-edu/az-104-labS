...
> **まとめ：今回のタスクでは、「セキュリティグループ」と動的メンバーシップについて確認しました。**
>
> 　　　　**動的メンバーシップの設定で、実際にユーザーなどが参加するのには10分前後かかります。**
>
> 　　　　**演習内では「ルールの検証」を使い、速やかに確認しました。**
>
> 　　　　**改めて参加しているか確認したい場合は、少し時間をあけて確認してください。**
>
> 　　　　**対象のグループを選択し「メンバー」から確認することが可能です。**



#### タスク 7：Microsoft365 グループの作成
...
- [x] 1.一覧にある「**Azure Active Directory Premium P2**」をクリックします。
- [x] 2.「**Azure Active Directory Premium P2 | ライセンスされているユーザー**」ブレードにある「**＋割り当て**」をクリックします。
- [x] 3.「**ライセンスの割り当て**」ブレードの「**ユーザーとグループ**」タブにある「**+ユーザーとグループの追加**」をクリックします。
- [x] 4.画面右から表示される「**ユーザーとグループの追加**」から「**LabUser-XXXXXXXX**」をクリックし、さらに「**選択**」をクリックします。
- [x] 5.画面下部にある「**レビューと割り当て**」をクリックします。
- [x] 6.「**ライセンスの割り当て**」ブレードの「**レビューと割り当て**」タブにある内容を確認し、「割り当て」をクリックます。