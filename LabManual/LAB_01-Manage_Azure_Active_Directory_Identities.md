...
- [ ] 2.「**Azure Active Directory Premium P2 | ライセンスされているユーザー**」ブレードにある「**＋割り当て**」をクリックします。
- [ ] 3.「**ライセンスの割り当て**」ブレードの「**ユーザーとグループ**」タブにある「**+ユーザーとグループの追加**」をクリックします。
- [ ] 4.画面右から表示される「**ユーザーとグループの追加**」から「**LabUser-XXXXXXXX**」をクリックし、さらに「**選択**」をクリックします。
- [ ] 5.画面下部にある「**レビューと割り当て**」をクリックします。
- [ ] 6.「**ライセンスの割り当て**」ブレードの「**レビューと割り当て**」タブにある内容を確認し、「割り当て」をクリックます。