...
1. Azure portal の画面上部にある検索ボックスに「**Microsoft Entra ID**」 と入力します。
...
1. 画面右より「**あなたがロボットではないことを確認させてください。**」と表示されます。
   ...
   > 注：「テナントの作成が進行中です。これには数分かかります。」と表示されます。
   >
   > 　　約2～5分ほどテナントの作成を待ちます。
...
1. 画面右側に「**アクティブ化**」が表示されます。
   ...
   「**MICROSOFT ENTRA ID P2**」項目の「**無料試用版**」を展開し、「**アクティブ化**」をクリックします。

1. 画面上部の通知アイコン より「**Microsoft Entra ID Premium P2 試用版が正常にアクティブ化されました**」と表示されるのを待ちます。
...
1. 「**ライセンス | すべての製品**」 ブレード内の一覧に「**Microsoft Entra ID Premium P2**」が表示されたことを確認します。
...
1. 画面中央にあるライセンスが「**Microsoft Entra ID P2**」と表示されたことを確認します。
...
1. 「**X**」(閉じる) をクリックして「**ライセンス割り当ての更新**」 ブレードを閉じ、「**az104-01a-aaduser2 | ライセンス**」ブレードに戻ります。
